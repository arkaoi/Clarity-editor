...
public:
  SkipListMap()
      : head_(new Node(MAX_LEVEL, Key(), Value())), level_(0), size_(0),
  ...
  public:
    ...
    reference operator*() const { return {n_->key, n_->value}; }

    bool operator==(iterator o) const { return n_ == o.n_; }
  ...
  iterator begin() const { return const_cast<SkipListMap *>(this)->begin(); }
  iterator end() const { return const_cast<SkipListMap *>(this)->end(); }
};
